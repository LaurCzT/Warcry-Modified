...
<head>
   ...
   -->
    ...
    <meta name="descriptipn" content="Welcome to the best free private server.">
    <meta name="keywords" content="example, example, example, WoW, World of Warcraft, Warcraft, wotlk, Wrath of the Lich King, wotlk server, Private Server, Private WoW Server, WoW Server, WoW Private Server, win a character, splash, splash page, reward, rewards">
    <meta name="language" content="English">
    <meta name="type" content="website">
    <meta name="copyright" content="Copyright www.example.com">
    <meta name="resource-type" content="games">
    <meta name="Distribution" content="Global">
    <meta name="email" content="webmaster@example.com">
    ...
    <meta name="DC.Rights" content="(c) example.com all rights reserved.">
                ...
                <p></p>
                	<div class="nddm-holder" align="center">
		                <div class="navi-dropdown">
                            ...
                            <span><a href="<?php echo $config['BaseURL']; ?>/forums.php?page=forum&id=49">Support</a></span>
...
<div id="image_header" <?php if(isset($_GET["page"]) == false || $_GET["page"] == "home") { echo 'class="home"'; } ?>  align="center">
	...
	else
	{
		if ($TPL->GetParameter('slider'))
		{
			...
			<!-- HTML5 Movie -->
			<div class="slider" id="example-slider" align="center">
			...
			$(document).ready(function()
			{
				$("#html5-video").videoBG(
				{
					mp4: "http://media.example.com/movies/cwc.mp4",
					ogv: "http://media.example.com/movies/cwc.ogv",
					webm: "http://media.example.com/movies/cwc.webm",
					poster: "http://media.example.com/movies/cwc.jpg",
					scale: true,
					loop: "loop",
					zIndex: 0
				});
