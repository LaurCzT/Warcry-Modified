...
<div class="index_news">
   	...
   	<div class="welcome_to_example">
    	<h1>Welcome to example</h1>
        <p>
        example is a quality warcraft server utilizing talented developers and resources to ensure the best blizz-like experience around. Our team is a dedicated team that professionally creates and maintain everyday features for the players. Register today!
        </p>
    </div>
		         ...
		         <div class="media-wrapp">
                    <div class="media-button-holder">
	                 	...
	                 	<div class="youtube media-new-design">
	                    	<a href="http://www.youtube.com/user/exampleWoW1" target="_blank"><div class="new-design-left-part"><p class="icon"></p><span>YouTube</span></div></a>
	                    </div>
                        <!-- New Media Button look.End -->
