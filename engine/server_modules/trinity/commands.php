...
class server_Commands
{
	...
	public function sendItems($charName, $items, $subject, $realmid)
	{
		...
		//try to send the items
		$soapMsg = $CORE->ExecuteSoapCommand('.send items '.$charName.' "'.$subject.'" "Thank you for your contribution and loyalty towards example. Here is your reward that you deserve. Have a nice day here at example and Don\'t forget to vote! Regards,
		example" '.$items, $realmid);
	...
	public function sendMoney($charName, $money, $subject, $realmid)
	{
		...
		$soapMsg = $CORE->ExecuteSoapCommand('.send money '.$charName.' "'.$subject.'" "Thank you for your contribution and loyalty towards example. Here is your reward that you deserve. Have a nice day here at example and Don\'t forget to vote! Regards,
		example" '.$money, $realmid);
