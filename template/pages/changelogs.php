    ...
    <div class="sub-page-title">
  	...
  	<div class="container_2" align="center">
            ...
            <div class="changelogs-cats">
                ...
                <a href="<?php echo $config['BaseURL'];?>/index.php?page=changelogs&changelog=2" <?php echo ($ChangelogID == CHANGELOG_CORE ? 'class="active"' : ''); ?>>Core Changelog<p> example Core changes and updates</p></a>
                <div class="clear"></div>
            </div>
										...
										$.ajax({
											...
											success: function(data)
											{
												...
												list.find('changeset').each(function(i, e)
												{
													...
													$('#changes-list').append(element);
													//queue the effects
													exampleQueue('changelogs').add(function()
													{
														element.fadeIn('slow', function()
														{
															exampleQueue('changelogs').goNext();
														});
													});
