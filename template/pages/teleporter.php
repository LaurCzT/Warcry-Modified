...
?>
<script src="http://www.example.com/template/js/teleporter.js"></script>
      	...
      	<div class="teleporter">
            ...
            <div class="container_3 account-wide padding-tele" align="center">            		
                ...
                <div class="map-holder" align="center">
                	...
                	<div class="tele-back-btn" style="display:none;"><a href="javascript: void(0);" id="tp-back"></a></div>
                    	...
                    	<div class="step-two" id="tp-mainmap-container">
                            <a href="javascript:void(0);" class="kalimdor" id="tp-btn-kalimdor"></a>
                            <a href="javascript:void(0);" class="eastern-kingdoms" id="tp-btn-eastern-kingdoms"></a>
                            <a href="javascript:void(0);" class="northrend" id="tp-btn-northrend"></a>
                        </div>
                        <!-- -->
                ...
                <div class="complete-tele-form active-tele-form" style="display:none; margin:6px 0 0 0;" align="left">
                    ...
                    <form action="<?php echo $config['BaseURL']; ?>/execute.php?take=teleport" class="teleport-form" method="get" onsubmit="return OnTeleportSubmit(this);">
                        <?php
