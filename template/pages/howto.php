                ...
                <div id="accordion">
	            	...
	            	<ul class="howto-row">
	                    ...
	                    <li class="howto-row-content">
	                        ...
	                        <p>5. Replace the text inside with "<span>set realmlist logon.example.com</span>" then save.</p>
                    ...
                    <ul class="howto-row">
	                    ...
	                    <li class="howto-row-content">
							...
							<br/><br/>
							<p><b>1.</b> Double-click your TeamSpeak 3 Icon on your Desktop to open up the Teamspeak 3 client.</p></br>
                           ...
                           <p><b>4.</b> Then fill in all the information that was given bellow. For your Username put in what ever you want (But better use your website Display Name). <br/><br/> IP: <b>ts.example.com</b><br/>Password: <b>There is no password!</b></p>
                            <img src="imagehere" style=" border-radius:8px;" />
                           <br/><br/>
	                ...
	                <ul class="howto-row">
	                    ...
	                    <li class="howto-row-content" style="display:none">
	                    	...
	                    	<p><b>4. <font color="#ad8c47">Email</font></b></p>
	                            ...
	                            <br/><br/>
	                            Make sure your email is active and accepts messages from @example.com.
		                        </p>
	                        ...
	                        <p><b>4. <font color="#ad8c47">Sharing account information</font></b></p>
	                            ...
	                            <br/><br/>
	                            2. Trying to trade your account is another stupid idea. First of all, if you think you can earn some money using example
	                            server you need to think again. The person who are you trying with can simply screenshot conversation which will 
	                            lead to your account permament suspenion. Trading accounts on example  is general not even possible because
                    ...
                    <ul class="howto-row">
	                    ...
	                    <li class="howto-row-content how-coins">
	                    	...
	                    	<ul class="methods-rows">
                                ...
                                <li>
                                <a href="<?php echo $config['BaseURL']; ?>/index.php?page=recruit-a-friend">RECRUIT A FRIEND</a> - Get one of your friends to play on example and level up a character to 60 or 80 for Death Knights and get 5 Gold Coins if your friend purchases 50 Gold Coins.
                                </li>
                            </ul>
                            ...
                            <ul class="methods-rows">
                                ...
                                <li>
                                    <a href="<?php echo $config['BaseURL']; ?>/index.php?page=recruit-a-friend">RECRUIT YOUR FRIENDS</a> - Get one of your friends to play on example and level up a character to 60 or 80 for Death Knights and get 1 Silver Coin if your friend votes for us.
                                </li>
                                
                                <li>
                                    <a href="<?php echo $config['BaseURL']; ?>/index.php?page=upload-screanshot">SUBMIT SCREENSHOTS</a> -  Capture your favorite moments on example and send them to us! You'll be given 1 Silver Coin for each screenshot that appears on our site.
                                </li>
                                ...
                                <li>
                                    <a href="#">LIKE US ON FACEBOOK</a> - Help us spread example and like us on Facebook. We'll give you 5 Silver Coins if you do!
                                </li>
