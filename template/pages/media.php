       ...
       <!-- Wallpapers -->
        	<div class="media-container flright half-w" align="left">
				...
				<ul class="screanshots screanshots-media-page">
					<li>
						<a href="index.php?page=all-wallpapers" class="container_frame" title="example Wallpaper One">
                    ...
                    <li>
						<a href="index.php?page=all-wallpapers" class="container_frame" title="example Wallpaper Two">
