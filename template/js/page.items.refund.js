...
function RefundItem(id)
{
	...
	$.ajaxSetup(
	{
		...
		{
			//prompt the error
			$.fn.exampleAlertBox('open', '<p>The Item Refund System encountered server error, please try again.</p>');
...
$(document).ready(function()
{
	...
	{
		exampleQueue('REFUND').add(function()
		{
