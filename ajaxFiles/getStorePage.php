...
$res = $DB->prepare("SELECT id, entry, realm, gold, silver, Quality FROM `store_items` ".$where." ORDER BY entry DESC LIMIT ".$offset.",".$perPage);
			...
			<html>  
				...
				<li id="store-item-', $i, '">
					<div id="item-cont">
						...
						<div class="item-info">
			           		<p class="'.strtolower($CORE->getItemQualityString($arr['Quality'])).'"></p>
