...
<h3>TERMS OF USE</h3>
<p>
By accessing or using www.example.com (the "Site") and affiliated services (the "Services") that belongs to example (example), you (the "User") agree to comply with the terms and conditions governing the User's use of any areas of the Site and affiliated services as set forth below.
</p>
<h3>USE OF SITE</h3>
<p>
This Site or any portion of the Site as well as the Services may not be reproduced, duplicated, copied, sold, resold, or otherwise exploited for any commercial purpose except as expressly permitted by example. example reserves the right to refuse service in its discretion, without limitation, if example believes that User conduct violates applicable law or is harmful to the interests of example, other users of the Site and the Services or its affiliates.
</p>
<h3>SITE ACCOUNT</h3>
<p>
...
<p>
example provides free and unlimited access to the Site and the Services.
</p>
<h3>SUBMISSION</h3>
<p>
example does not assume any obligation with respect to any Submission and no confidential or fiduciary understanding or relationship is established by the Site's receipt or acceptance of any submission. All submissions become the exclusive property of the Site and its affiliates. The Site and its affiliates may use any submission without restriction and the User shall not be entitled to any compensation.
</p>
<h3>VERIFICATION</h3>
<p>
...
Certain user information collected through the use of this website is automatically stored for reference. We track such information to perform internal research on our users' demographic interests and behaviour and to better understand, protect and serve our community of users. Payment or any other financial information is NEVER submitted, disclosed or stored on the Site and is bound to Terms and Conditions and Privacy Policy of our respective partners and/or payment processors. Basic user information (such as IP address, logs for using website interface and account management) may be disclosed to our partners in mutual efforts to counter potential illegal activities. example makes significant effort to protect..
                ...
                <input type="submit" class="agree" id="i-agree" value="I Agree the Terms of example" style="margin:10px 0 0 0;" />
