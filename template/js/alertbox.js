...
(function($)
{
	...
	var methods =
	{
				...
				for (var key in buttons)
				{
					...
					if (typeof button.onclick == 'string')
					{
						if (button.onclick == 'close')
							$(newButton).click(function(){ $.fn.exampleAlertBox('close'); return false; });
					}
  	...
  	$.fn.exampleAlertBox = function(method)
  	{
  		if (methods[method])
		{
		...
		{
      		$.error( 'Method ' +  method + ' does not exist on jQuery.exampleAlertBox');
    	}    
  	};
