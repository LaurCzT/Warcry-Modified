...
$stats->updateRealmStats($RealmId);

//get the characters online count
$count = $stats->getOnline();

//Set the title
$TPL->SetTitle('Frostwolf Realm Details');
//CSS
    	...
    	<!-- REALM TOP INFO -->
        	<div class="realm_main_info">
                ...
                <h2>
                    ...
                    <div class="overlay_2"></div>
                    <div>
                    	Blizzlike Content, High Rate Realm
                        <div class="overlay_1"></div>
                    </div>
                </h2>
        ...
        <!-- REALM Info -->
        	<div class="realm_info">
            	<span>
                    ...
                    <h2>
                    Experience Warth of the Lich King in a much faster paced  environment with our High Rate Realm, Frostwolf!
                    <br/><br/>
                    Frostwolf is in constant development and issues are being resolved and working content is added all the time. Visit our Working Content page for a full overview of all the content available.
                    </h2>
                </span>
            </div>
        <!-- REALM Info.End -->
            ...
            <!-- REALM STATISTICS -->
                <div class="realm_statistics">
                    ...
                    <div class="statistics_note">
                        <h3>Statistics displayed on this page do not include characters below level 10.</h3>
                    </div>
                    <br/><br/>
