...
$update->bindParam(':user', $updatePost['user'], PDO::PARAM_INT);
$update->bindParam(':time', $updatePost['time'], PDO::PARAM_STR);
$update->bindParam(':post', $updatePost['post'], PDO::PARAM_INT);
$update->execute();
