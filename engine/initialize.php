...
require_once 'E:\xampp\htdocs\engine\core.php';
...
$CORE = new CORE();
	...
	try
	{
        ...
        $CORE->register_Module('profile', 'CORE');
        $CORE->register_Module('account.activity', 'CORE');
        ...
        $CORE->register_Module('armory', 'SERVER', $server_config['CORE']);
	} 
	catch (Exception $e)
	{
